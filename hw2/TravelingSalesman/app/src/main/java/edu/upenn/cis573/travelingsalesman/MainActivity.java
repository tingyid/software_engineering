...
public class MainActivity extends Activity implements OnItemSelectedListener {
    ...
    // string to send with numLocations extra
    public static final String EXTRA_NUM_LOCATIONS = "edu.upenn.cis573.travelingsalesman.NUM_LOCATIONS";
    ...
    public void onButtonClick(View button) {
        ...
        i.putExtra(EXTRA_NUM_LOCATIONS, numLocations);
        startActivity(i);
    }
